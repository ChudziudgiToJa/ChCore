...
public class Kits {
    ...
    public static List<ItemStack> ironNetherite() {
        List<ItemStack> list = new ArrayList<>();

        list.add(new ItemBuilder(Material.NETHERITE_HELMET)
                .setTitle("&7Hełm &34/3")
                .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4)
                .addEnchant(Enchantment.DURABILITY, 3)
                .build());

        list.add(new ItemBuilder(Material.NETHERITE_CHESTPLATE)
                .setTitle("&7Klata &34/3")
                .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4)
                .addEnchant(Enchantment.DURABILITY, 3)
                .build());

        list.add(new ItemBuilder(Material.NETHERITE_LEGGINGS)
                .setTitle("&7Spodnie &34/3")
                .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4)
                .addEnchant(Enchantment.DURABILITY, 3)
                .build());

        list.add(new ItemBuilder(Material.NETHERITE_BOOTS)
                .setTitle("&7Buty &34/3")
                .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4)
                .addEnchant(Enchantment.DURABILITY, 3)
                .build());

        list.add(new ItemBuilder(Material.NETHERITE_SWORD)
    ...
    public static List<ItemStack> ironDiamond() {
        List<ItemStack> list = new ArrayList<>();

        list.add(new ItemBuilder(Material.DIAMOND_HELMET)
                .setTitle("&7Hełm &34/3")
                .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4)
                .addEnchant(Enchantment.DURABILITY, 3)
                .build());

        list.add(new ItemBuilder(Material.DIAMOND_CHESTPLATE)
                .setTitle("&7Klata &34/3")
                .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4)
                .addEnchant(Enchantment.DURABILITY, 3)
                .build());

        list.add(new ItemBuilder(Material.DIAMOND_LEGGINGS)
                .setTitle("&7Spodnie &34/3")
                .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4)
                .addEnchant(Enchantment.DURABILITY, 3)
                .build());

        list.add(new ItemBuilder(Material.DIAMOND_BOOTS)
                .setTitle("&7Buty &34/3")
                .addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4)
                .addEnchant(Enchantment.DURABILITY, 3)
                .build());
        ...
        list.add(new ItemBuilder(Material.DIAMOND_PICKAXE)
                .setTitle("&7Kilof &35/3/3")
                .addEnchant(Enchantment.DIG_SPEED, 5)
                .addEnchant(Enchantment.DURABILITY, 3)
                .addEnchant(Enchantment.LOOT_BONUS_BLOCKS, 3)
    ...
    public static List<ItemStack> ironIron() {
        List<ItemStack> list = new ArrayList<>();
        ...
        list.add(new ItemBuilder(Material.IRON_PICKAXE)
                .setTitle("&7Kilof &35/3/3")
                .addEnchant(Enchantment.DIG_SPEED, 5)
                .addEnchant(Enchantment.DURABILITY, 3)
                .addEnchant(Enchantment.LOOT_BONUS_BLOCKS, 3)
    ...
    public static List<ItemStack> goldIron() {
        List<ItemStack> list = new ArrayList<>();
    ...
    public static List<ItemStack> goldDiamoend() {
        List<ItemStack> list = new ArrayList<>();
    ...
    public static List<ItemStack> goldNetherite() {
        List<ItemStack> list = new ArrayList<>();
