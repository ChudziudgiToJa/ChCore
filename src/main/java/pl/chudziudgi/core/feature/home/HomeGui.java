...
public class HomeGui {
    ...
    public static void openSetHome(final Player player) {
        ...
        final ItemStack home1 = new ItemBuilder((homeManager.isHome(user.homeLocation1) ? Material.LIGHT_BLUE_DYE : Material.GRAY_DYE)).setTitle("&7DOM I").addLore("", (homeManager.isHome(user.homeLocation1) ? "&cMasz już dom. Aby go usunąć &c/dom usun" : "&7Kliknij &3▜&7▛, aby ustawić dom")).setGlow(homeManager.isHome(user.homeLocation1)).build();
        final ItemStack home2 = new ItemBuilder((homeManager.isHome(user.homeLocation2) ? Material.LIGHT_BLUE_DYE : Material.GRAY_DYE)).setTitle("&7DOM II").addLore("", (player.hasPermission("core.home.iron") ? (homeManager.isHome(user.homeLocation2) ? "&cMasz już dom. Aby go usunąć &c/dom usun" : "&7Kliknij &3▜&7▛, aby ustawić dom") : "&cNie posiadasz rangi &f&lIRON")).setGlow(homeManager.isHome(user.homeLocation2)).build();
        final ItemStack home3 = new ItemBuilder((homeManager.isHome(user.homeLocation3) ? Material.LIGHT_BLUE_DYE : Material.GRAY_DYE)).setTitle("&7DOM III").addLore("", (player.hasPermission("core.home.gold") ? (homeManager.isHome(user.homeLocation3) ? "&cMasz już dom. Aby go usunąć &c/dom usun" : "&7Kliknij &3▜&7▛, aby ustawić dom") : "&cNie posiadasz rangi &e&lGOLD")).setGlow(homeManager.isHome(user.homeLocation3)).build();
