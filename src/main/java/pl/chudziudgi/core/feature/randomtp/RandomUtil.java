...
public final class RandomUtil {
    ...
    public static Location getRandomCords(int i) {
        ...
        while (location.getBlock().getBiome() == Biome.OCEAN || location.getBlock().getBiome() == Biome.DEEP_OCEAN || location.getBlock().getBiome() == Biome.RIVER || location.getBlock().getType() == Material.WATER || location.getBlock().getType() == Material.LAVA) {
